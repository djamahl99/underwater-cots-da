...
class kaggle_aims_pair(data.Dataset):
    def __init__(self) -> None:
        ...
        self.aims_imgs_list = [{
            ...
            } for x in tqdm(aims_data['images'])]
        ...
        self.kaggle_imgs_list = [{
            ...
            } for x in tqdm(kaggle_data['images'])]
    ...
    def __getitem__(self, index) -> tuple:
        ...
        return self.transform(kaggle_img), self.transform(aims_img), torch.tensor(kaggle_label), torch.tensor(aims_label)
